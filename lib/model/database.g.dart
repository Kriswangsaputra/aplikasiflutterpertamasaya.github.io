...
class $KategoriTable extends Kategori
    with TableInfo<$KategoriTable, Kategories> {
  @override
  ...
  @override
  VerificationContext validateIntegrity(Insertable<Kategories> instance,
  ...
  @override
  Kategories map(Map<String, dynamic> data, {String? tablePrefix}) {
...
class Kategories extends DataClass implements Insertable<Kategories> {
  final int id;
  final String name;
  final int type;
  ...
  factory Kategories.fromJson(Map<String, dynamic> json,
  ...
  @override
  String toString() {
    return (StringBuffer('Kategories(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('type: $type, ')
...
class KategoriCompanion extends UpdateCompanion<Kategories> {
  final Value<int> id;
  ...
  KategoriCompanion.insert({
    ...
    this.deletedAt = const Value.absent(),
        ...
        createdAt = Value(createdAt),
        updatedAt = Value(updatedAt);
  static Insertable<Kategories> custom({
    Expression<int>? id,
